...
{  
    ...
    // 2. 注册命令处理器  
    ret = command_dispatcher_register(RELAY_COMMAND_PREFIX, relay_two_command_handler);  
    if (ret != ESP_OK) {  
